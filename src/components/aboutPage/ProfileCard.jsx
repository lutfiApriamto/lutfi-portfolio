  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          className="grid relative overflow-hidden backface-hidden rounded-2xl"
            style={{
                width: '100%', // Menjadikan kartu fluid mengikuti container pembungkusnya
                aspectRatio: '0.718', // Rasio kartu tetap terjaga sempurna
        ...
        >
          ...
          >
            ...
            >
              ...
              {showUserInfo && (
                <div
                  className="absolute bottom-2.5 left-2.5 right-2.5 sm:bottom-5 sm:left-5 sm:right-5 z-[2] flex items-center justify-between backdrop-blur-[30px] border border-white/10 pointer-events-auto p-2 sm:p-3.5"
                  style={{
                    background: 'rgba(255, 255, 255, 0.1)',
                    borderRadius: 'calc(max(0px, var(--card-radius) - 12px))',
                  }}
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-white/10 flex-shrink-0 w-8 h-8 sm:w-12 sm:h-12"
                    >
                      <img
                    ...
                    <div className="flex flex-col items-start gap-0.5 sm:gap-1.5">
                      <div className="text-[10px] sm:text-sm font-medium text-white/90 leading-none">@{handle}</div>
                      <div className="text-[9px] sm:text-xs text-white/70 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-white/10 rounded-md sm:rounded-lg px-2.5 py-1.5 sm:px-4 sm:py-3 text-[10px] sm:text-xs font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px"
                    onClick={handleContactClick}
                    style={{ pointerEvents: 'auto', display: 'block', gridArea: 'auto' }}
                    type="button"
