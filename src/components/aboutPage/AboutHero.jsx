...
import ProfileCard from './ProfileCard'; // Pastikan path ini sesuai

const AboutHero = () => {
  // Konfigurasi Variasi Animasi Fade In & Up
  ...
  const containerVariants = {
    ...
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: 0.15, // Efek animasi berurutan antarelemen
      }
    }
  };

  return (
    <section className="relative w-full min-h-screen flex items-center justify-center pt-28 pb-16 px-6 md:px-12 lg:px-24 mx-auto overflow-hidden">
      ...
      <motion.div 
        ...
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.15 }} // Scroll reveal aktif sekali saat di-scroll
      >
        ...
        <motion.div 
          ...
          variants={fadeInVariants}
        >
          {/* Penyesuaian Ukuran: max-w-[260px] di mobile agar pas & kecil di tengah, meningkat di sm dan lg */}
