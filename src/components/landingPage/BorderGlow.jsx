  ...
  return (
    <div
      ...
      style={{
        ...
        // overflow visible agar outer glow tidak terpotong
        overflow: 'visible',
    ...
    >
      ...
      {/* outer glow — butuh overflow visible di parent agar tidak terpotong */}
      <span
      ...
      {/* content — overflow hidden di sini saja agar content tidak bocor */}
      <div
